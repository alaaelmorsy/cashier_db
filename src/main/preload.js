  ...
  try {
    ...
    try {
      Object.assign(TR.ar_to_en, {
        ...
        // Main home cards extra labels
        '🛒 نقطة البيع': '🛒 POS',
        'اختصار: F1': 'Shortcut: F1',
        'إدارة WhatsApp': 'WhatsApp Management',
        'الفاتورة الإلكترونية': 'E-Invoice',
        'السندات': 'Vouchers',
        'سندات القبض والصرف': 'Receipt and payment vouchers',
        'الموردون': 'Suppliers',
        'إضافة/إدارة الموردين': 'Add/Manage suppliers',
        'الموظفون': 'Employees',
        'إضافة/إدارة الموظفين': 'Add/Manage employees',
        'فواتير الشراء': 'Purchase Invoices',
        'إنشاء وإدارة فواتير الشراء': 'Create and manage purchase invoices',
        'عرض تقارير المبيعات والإحصائيات': 'View sales reports and statistics',
        'الإعدادات': 'Settings',
        'نظام الرابط': 'Al-Rabit System',
        'عروض الأسعار': 'Quotations',
        'إدارة وطباعة عروض الأسعار': 'Manage and print quotations',
        'الشيفتات': 'Shifts',
        'إدارة الشيفتات': 'Manage shifts',
        'عرض وإدارة الشيفتات': 'View and manage shifts',
        'ربط WhatsApp وإرسال الفواتير': 'Connect WhatsApp and send invoices',
        'إعداد وإدارة نظام ZATCA الضريبي': 'Configure and manage ZATCA tax system',
        // Sales screen full coverage
        'فاتورة جديدة - POS SA': 'New Invoice - POS SA',
        'فاتورة جديدة': 'New Invoice',
        '🔒 إغلاق الشيفت': '🔒 Close Shift',
        'إغلاق الشيفت': 'Close Shift',
        'إغلاق الإشعار': 'Close notification',
        'تحذير: أصناف قرب نفاد المخزون': 'Warning: Items are near out of stock',
        '📋 الفواتير المعلقة': '📋 Held invoices',
        'إغلاق': 'Close',
        'تأكيد تفريغ السلة': 'Confirm cart clear',
        'هل تريد تفريغ السلة الآن؟': 'Do you want to clear the cart now?',
        'تأكيد حذف الفاتورة': 'Confirm invoice deletion',
        'هل تريد حذف الفاتورة المعلقة؟': 'Do you want to delete the held invoice?',
        'الصنف غير موجود': 'Product not found',
        'الباركود المدخل غير موجود في النظام. هل تريد إضافة منتج جديد؟': 'The entered barcode is not found in the system. Do you want to add a new product?',
        '➕ إضافة عميل جديد': '➕ Add new customer',
        '👤 اسم العميل الكامل': '👤 Customer full name',
        'أدخل اسم العميل...': 'Enter customer name...',
        '📱 رقم الجوال': '📱 Mobile number',
        'مثال: 0501234567': 'Example: 0501234567',
        '📧 البريد الإلكتروني': '📧 Email',
        '📍 العنوان': '📍 Address',
        '🏢 الرقم الضريبي (اختياري)': '🏢 VAT number (optional)',
        'مثال: 300123456700003': 'Example: 300123456700003',
        '🧾 رقم السجل التجاري (اختياري)': '🧾 CR number (optional)',
        'مثال: 1010123456': 'Example: 1010123456',
        '🏠 العنوان الوطني (اختياري)': '🏠 National address (optional)',
        'مثال: 1234-حي-مدينة-رمز بريدي': 'Example: 1234-district-city-postal code',
        '📝 ملاحظات إضافية': '📝 Additional notes',
        'أي ملاحظات خاصة بالعميل...': 'Any notes about the customer...',
        '❌ إلغاء': '❌ Cancel',
        '✅ حفظ البيانات': '✅ Save data',
        '🔍 ابحث برقم أو اسم العميل': '🔍 Search by invoice number or customer name',
        '➕ إضافة منتج جديد': '➕ Add new product',
        '📦 اسم المنتج (عربي)': '📦 Product name (Arabic)',
        '📦 اسم المنتج (عربي) *': '📦 Product name (Arabic) *',
        'أدخل اسم المنتج...': 'Enter product name...',
        '🏷️ اسم المنتج (إنجليزي)': '🏷️ Product name (English)',
        '🔢 الباركود': '🔢 Barcode',
        '🔢 الباركود *': '🔢 Barcode *',
        'الباركود': 'Barcode',
        ...
        '💰 سعر البيع *': '💰 Sale price *',
        '📉 الحد الأدنى لسعر البيع': '📉 Minimum sale price',
        '📊 المخزون': '📊 Stock',
        '📁 الفئة': '📁 Category',
        'اختر الفئة...': 'Select category...',
        '📅 تاريخ انتهاء الصلاحية (اختياري)': '📅 Expiry date (optional)',
        '📝 الوصف': '📝 Description',
        'وصف المنتج (اختياري)...': 'Product description (optional)...',
        '🖼️ صورة المنتج': '🖼️ Product image',
        'اختيار صورة': 'Pick image',
        'إزالة الصورة': 'Remove image',
        '🔒 إخفاء المنتج من شاشة الفاتورة': '🔒 Hide product from invoice screen',
        '🚫 استثناء هذا الصنف من الضريبة (VAT)': '🚫 Exempt this item from VAT',
        '🔧 عمليات المنتج وأسعارها': '🔧 Product operations and prices',
        'اختر عملية': 'Select operation',
        'السعر': 'Price',
        'إضافة': 'Add',
        ...
        'طباعة الفاتورة (F1)': 'Print invoice (F1)',
        'عرض السعر (F3)': 'Quotation (F3)',
        'قبل الضريبة': 'Pre-VAT',
        'ض.القيمة المضافة': 'VAT',
        'الإجمالي': 'Total',
        'إضافى': 'Extra',
        'بعد الخصم': 'After discount',
        'رسوم تبغ': 'Tobacco fee',
        'تعليق الفاتورة (F5)': 'Hold invoice (F5)',
        '⏸️ تعليق (F5)': '⏸️ Hold (F5)',
        'عرض الفواتير المعلقة': 'Show held invoices',
        '📋 المعلقة': '📋 Held',
        ...
        'الكوبون': 'Coupon',
        'اختر عميلًا': 'Select customer',
        'بدون سائق': 'No driver',
        'ملاحظاتك...': 'Your notes...',
        'الوحدات المتاحة': 'Available units',
        'لا توجد وحدات متاحة': 'No units available',
        'اختر الموظف': 'Select employee',
        'اختر': 'Select',
        'نقصان': 'Decrease',
        'زيادة': 'Increase',
        'حذف': 'Del',
        'وصف الصنف (اختياري)': 'Item description (optional)',
        'الصنف': 'Item',
        'المخزون': 'Stock',
        'الحد الأدنى': 'Min Price',
        '❌ يرجى إدخال اسم المنتج (عربي)': '❌ Please enter product name (Arabic)',
        '❌ يرجى إدخال سعر البيع': '❌ Please enter sale price',
        '✓ تم إضافة المنتج بنجاح': '✓ Product added successfully',
        'يرجى إدخال اسم العملية': 'Please enter operation name',
        'جاري الحفظ...': 'Saving...',
        'فشل الحفظ': 'Save failed',
        'حدث خطأ أثناء الحفظ': 'Error while saving',
        '✓ حفظ': '✓ Save',
        'المبلغ المدفوع': 'Amount paid',
        'المبلغ النقدي (مختلط)': 'Cash amount (mixed)',
        'غير متاح لهذه الطريقة': 'Not available for this method',
        'المبلغ المستلم': 'Amount received',
        'العميل:': 'Customer:',
        'غير محدد': 'Not specified',
        'الكمية المتبقية:': 'Remaining qty:',
        '⏳ جاري الإصدار...': '⏳ Issuing...',
        '✓ إصدار إشعار دائن': '✓ Issue credit note',
        // Customers
        ...
        // Purchase Invoices screen - full coverage
        'فاتورة شراء - POS SA': 'Purchase Invoice - POS SA',
        'فاتورة شراء': 'Purchase Invoice',
        'إدارة الفواتير': 'Invoice Management',
        'إنشاء فواتير شراء جديدة أو مراجعة الفواتير المحفوظة': 'Create new purchase invoices or review saved invoices',
        'إنشاء فاتورة': 'New Invoice',
        'الفواتير المحفوظة': 'Saved Invoices',
        'المشتريات المرتجعة': 'Purchase Returns',
        'البيانات العامة للفاتورة': 'Invoice General Info',
        'أدخل المعلومات الأساسية للفاتورة': 'Enter the basic invoice information',
        'رقم الفاتورة': 'Invoice No.',
        'يتم توليده تلقائياً': 'Auto-generated',
        'يتولد تلقائياً عند الحفظ': 'Auto-generated on save',
        'تاريخ/وقت الفاتورة': 'Invoice Date/Time',
        'المورد': 'Supplier',
        ...
        '💳 شبكة': '💳 Network',
        '📄 آجل': '📄 Credit',
        'رقم مرجع (اختياري)': 'Reference No. (optional)',
        'رقم فاتورة المورد': 'Supplier invoice no.',
        'أضف ملاحظة...': 'Add a note...',
        'الأصناف المشتراة': 'Purchased Items',
        'أضف الأصناف باستخدام البحث أو الباركود': 'Add items using search or barcode',
        'ابحث بالاسم أو الباركود...': 'Search by name or barcode...',
        'الكود': 'Code',
        'اسم الصنف': 'Item Name',
        'سعر الشراء': 'Purchase Price',
        ...
        'مراجعة المبالغ والضرائب': 'Review amounts and taxes',
        'الإجمالي قبل الضريبة': 'Subtotal (before VAT)',
        'الخصم العام': 'General Discount',
        'وضع سعر الشراء': 'Purchase Price Mode',
        'السعر شامل الضريبة': 'Price includes VAT',
        'السعر غير شامل الضريبة': 'Price excludes VAT',
        'بدون ضريبة': 'No VAT',
        'نسبة الضريبة %': 'VAT %',
        ...
        'تصفية الفواتير': 'Filter Invoices',
        'ابحث عن الفواتير بالتاريخ أو المورد': 'Search invoices by date or supplier',
        'من': 'From',
        'إلى': 'To',
        'مسح': 'Clear',
        'قائمة الفواتير': 'Invoice List',
        'الفواتير المحفوظة مع إمكانية التعديل': 'Saved invoices with edit capability',
        '0 فاتورة': '0 Invoices',
        '10 لكل صفحة': '10 per page',
        '20 لكل صفحة': '20 per page',
        '50 لكل صفحة': '50 per page',
        '100 لكل صفحة': '100 per page',
        'التاريخ': 'Date',
        'رقم الفاتورة': 'Invoice No.',
        'حالة الدفع': 'Payment Status',
        'إجراءات': 'Actions',
        'البحث برقم الفاتورة...': 'Search by invoice number...',
        ...
        '🗑️ حذف': '🗑️ Delete',
        '🗑 حذف': '🗑 Delete',
        'رقم الفاتورة الأصلية': 'Original Invoice No.',
        'أدخل رقم الفاتورة الأصلية': 'Enter original invoice no.',
        '⚙️': '⚙️',
        'معالجة': 'Process',
        '<span>⚙️</span> معالجة': '<span>⚙️</span> Process',
        'أصناف الفاتورة الأصلية - حدد الكميات المرتجعة': 'Original Invoice Items - Select Return Quantities',
        'تحديد': 'Select',
        'المنتج': 'Product',
        'الكمية الأصلية': 'Original Qty',
        'الكمية المرتجعة سابقاً': 'Previously Returned',
        'المتاح للإرجاع': 'Available to Return',
        'الكمية المرتجعة': 'Return Qty',
        'سعر الوحدة': 'Unit Price',
        'سبب الإرجاع': 'Return Reason',
        'سبب المرتجع (اختياري)': 'Return reason (optional)',
        'إجمالي المرتجع:': 'Return Total:',
        'حفظ وطباعة المرتجع': 'Save & Print Return',
        '<span>💾</span> حفظ وطباعة المرتجع': '<span>💾</span> Save & Print Return',
        'فواتير المرتجعات المحفوظة': 'Saved Return Invoices',
        'عرض جميع فواتير المرتجعات': 'View all return invoices',
        'من تاريخ': 'From Date',
        'إلى تاريخ': 'To Date',
        'رقم المرتجع': 'Return No.',
        'رقم الفاتورة الأصلية': 'Original Invoice No.',
        'لا توجد مرتجعات': 'No Returns',
        'أنشئ مرتجع جديد من الأعلى': 'Create a new return from above',
        'تأكيد حذف الفاتورة': 'Confirm Invoice Deletion',
        'هل أنت متأكد من حذف هذه الفاتورة؟': 'Are you sure you want to delete this invoice?',
        'سيتم تعديل المخزون': 'Inventory will be adjusted',
        'سيتم تعديل حساب المورد': 'Supplier account will be adjusted',
        'سيتم حذف البيانات نهائياً': 'Data will be permanently deleted',
        'تأكيد الحذف': 'Confirm Delete',
        'تأكيد': 'Confirm',
        'تأكيد': 'Confirm',
        '✅ تم حفظ الفاتورة بنجاح': '✅ Invoice saved successfully',
        'جاري تحميل بيانات الفاتورة...': 'Loading invoice data...',
        '❌ فشل تحميل بيانات الفاتورة': '❌ Failed to load invoice data',
        '❌ حدث خطأ أثناء تحميل الفاتورة': '❌ Error loading invoice',
        '🖨️': '🖨️',
        ...
        'جرّب تغيير معايير البحث أو قم بإنشاء فاتورة جديدة': 'Try changing search criteria or create a new invoice',
        'مرحباً بك في إدارة فواتير الشراء': 'Welcome to Purchase Invoice Management',
        'أدخل تاريخ من وإلى ثم اضغط بحث، أو أدخل رقم الفاتورة للبحث المباشر': 'Enter date range and click search, or enter invoice number for direct search',
        'معايير البحث مطلوبة': 'Search criteria required',
        'يجب إدخال تاريخ من وإلى أو رقم فاتورة للبحث': 'You must enter a date range or invoice number to search',
        'ابحث عن الفواتير': 'Search Invoices',
        'تم مسح معايير البحث': 'Search criteria cleared',
        'يرجى اختيار المورد قبل الحفظ': 'Please select a supplier before saving',
        'لا توجد أصناف في الفاتورة': 'No items in the invoice',
        'لا توجد أصناف': 'No items',
        'يرجى اختيار منتج صحيح وكميات موجبة': 'Please select a valid product with positive quantities',
        ...
        'تعذر فتح العرض: ': 'Failed to open view: ',
        'يرجى إدخال رقم الفاتورة': 'Please enter invoice number',
        'الفاتورة غير موجودة': 'Invoice not found',
        'لا توجد أصناف متاحة للإرجاع': 'No items available for return',
        'تم جلب بيانات الفاتورة بنجاح': 'Invoice data loaded successfully',
        'حدث خطأ أثناء جلب البيانات': 'Error fetching data',
        'يرجى تحديد أصناف للإرجاع': 'Please select items to return',
        'فشل حفظ المرتجع': 'Failed to save return',
        'تم إنشاء فاتورة المرتجع بنجاح': 'Return invoice created successfully',
        'حدث خطأ أثناء الحفظ': 'Error while saving',
        'وصف الصنف (يظهر في الطباعة)...': 'Item description (appears in print)...',
        '🗑 حذف': '🗑 Delete',
        'تنبيه': 'Warning',
        'نجح': 'Success',
        'خطأ': 'Error',
        ...
        'المورد:': 'Supplier:',
        'جوال المورد:': 'Supplier Mobile:',
        'الرقم الضريبي للمورد:': 'Supplier VAT No.:',
        'رقم فاتورة المورد:': 'Supplier Invoice No.:',
        'الصنف': 'Item',
        'الإجمالي قبل الضريبة': 'Subtotal (before VAT)',
        'الضريبة': 'VAT',
        'الخصم العام (غير شامل)': 'General Discount (excl.)',
        'ملاحظات:': 'Notes:'
      }); TR.en_to_ar = Object.fromEntries(Object.entries(TR.ar_to_en).map(([a, e]) => [e, a]));
    } catch (_) { }
    ...
    TR.patterns_ar_en = [
      ...
      { re: /^(\d+)\s+فاتورة$/u, to: (_m, n) => `${n} Invoices` },
      { re: /^⚠\s+مدفوع جزئياً$/u, to: () => '⚠ Partially Paid' },
      { re: /^مدفوع جزئياً$/u, to: () => 'Partially Paid' },
      { re: /^([\d.,]+)\s+من\s+([\d.,]+)$/u, to: (_m, a, b) => `${a} of ${b}` }
    ];
    TR.patterns_en_ar = [
      ...
      { re: /^([\d.,]+)\s+of\s+([\d.,]+)$/u, to: (_m, a, b) => `${a} من ${b}` }
    ];
      ...
      window.addEventListener('DOMContentLoaded', () => {
        document.addEventListener('contextmenu', (e) => {
          try {
            ...
            e.preventDefault();
            ipcRenderer.invoke('context:show', { lang: _ctxGetLang() }).catch(() => {});
          } catch (_) {}
        });
      });
    })();
